...
(function(module, exports2) {
  !function(e, t2) {
    ...
    return function(t2, i, s) {
      var a = function(t3) {
        return t3.add(4 - t3.isoWeekday(), e);
      }, d = i.prototype;
      d.isoWeekYear = function() {
        return a(this).year();
      }, d.isoWeek = function(t3) {
        if (!this.$utils().u(t3))
          return this.add(7 * (t3 - this.isoWeek()), e);
      ...
      var n = d.startOf;
      d.startOf = function(e2, t3) {
        var i2 = this.$utils(), s2 = !!i2.u(t3) || t3;
        return i2.p(e2) === "isoweek" ? s2 ? this.date(this.date() - (this.isoWeekday() - 1)).startOf("day") : this.date(this.date() - 1 - (this.isoWeekday() - 1) + 7).endOf("day") : n.bind(this)(e2, t3);
      };
    };
  });
})(isoWeek$1);
...
const Dialog = (p2) => {
  ...
  const node = withNativeProps(props, React__default["default"].createElement("div", {
    ...
    style: {
      pointerEvents: props.visible ? void 0 : "none"
    }
  }, React__default["default"].createElement(web.animated.div, {
    style
  }, body))));
...
function show(p2) {
  ...
  render(React__default["default"].createElement(TempToast, {
    ref
  }), container);
  return {
    close: () => {
